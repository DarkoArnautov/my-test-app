...
export default async function RootLayout({
  ...
  const archivedMeetings = await getArchievedMeetings("recent");
  const upcomingMeetings = await getUpcomingdMeetings("recent");
  ...
  return (
    ...
    >
      <body>
        <ApplicationLayout
          archievedMeetings={archivedMeetings.meetinglist}
          upcomingMeetings={upcomingMeetings.meetinglist}
        >
          {children}
        </ApplicationLayout>
      </body>
